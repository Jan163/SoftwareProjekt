    ...
    <body>
            ...
            <script>
                ...
                function check(cb) 
                {
                    if(cb.checked)
                    {
                        ...
                        <?php //if($pdo->exec("UPDATE spiele SET 1_cup_1 = 0 WHERE spiel_id = $spiel_id;"))?>



                        //var string =    '$statement = $pdo->prepare("UPDATE spiele SET 1_cup_1 = ? WHERE spiel_id = cb.value");?>'+
                ...
                function tische(tischauswahl)
                {
                    if(tischauswahl.checked)
                    {
                        var string ='<table style="width:60%">'+
                                    ...
                                    '<input type="checkbox" id="1_cup_1" class="cups" name="1_cup_1" value='+tischauswahl.value+' onchange="<?php if($pdo->exec("UPDATE spiele SET 1_cup_1 = 0 WHERE spiel_id = $spiel_id;"))?>>'+    
        ...
        <!-- TISCHANZEIGE SKRIPT-->
            ...
            /*
                ...
                if(cb.checked)
                {
                    $abfrage2 = <?php /*"SELECT tischnr,spiel_id FROM spiele Where spiel_id=1050";*/?>
