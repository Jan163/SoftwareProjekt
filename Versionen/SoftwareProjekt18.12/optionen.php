...
<div class="login-card">
    ...
    <tr>
        <td>Spielezeit:</td>
        <td><input type="time" id="Spielezeit" name="zeit" required = "true" > hh:mm </td><!--noch irgendwie im placeholder oder so anzeigen -->
    </tr>
    <tr>
        <td>Zeit zwischen den Spielen:</td>
        <td><input type="time" id="pausenzeit" name="timeout" required = "true">hh:mm</td><!--noch irgendwie im placeholder oder so anzeigen -->
    </tr>
    </table>
