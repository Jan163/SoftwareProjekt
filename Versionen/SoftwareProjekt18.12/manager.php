<?php  
    ...
    $statement="SELECT gruppengroesse,teams_pro_gruppe,uebrigeteams,aktuelleRunde FROM turnieroptionen WHERE turnier_id ='$turnier_id'";
    ...
    $manager="SELECT managercode FROM turnieroptionen WHERE turnier_id = '$turnier_id'";
    foreach($pdo->query($manager) as $for)
                    { 
                        $managercode=$for['managercode']; 
                    }
        ...
        <div class="card">
            ...
            <table class="tablelinks">
                ...
                <tr>
                    <td>
                         <?php if ($anzeigen == false): ?>
			                <button type="submit" name="turnier">Turnier starten</button>
		                <?php else: ?>
			                <button type="submit" name="turnier" >Turnier beenden</button>
		                <?php endif ?>
                    </td>
